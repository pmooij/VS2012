...
GO
CREATE NONCLUSTERED INDEX [IX_DimEmployee_ParentEmployeeKey]
    ON [dbo].[DimEmployee]([ParentEmployeeKey] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_DimEmployee_SalesTerritoryKey]
    ON [dbo].[DimEmployee]([SalesTerritoryKey] ASC);
